...
class TestBusFare(unittest.TestCase):
    ...
    def test_child_under_2_free(self):
        dt = datetime(2024, 5, 6, 10, 0)  # Weekday, off-peak
    ...
    def test_teenager_half_fare(self):
        ...
        self.assertEqual(fare, 1.5)  # Half of base fare ($3.0)
    ...
    def test_weekend_flat_rate(self):
        dt = datetime(2024, 5, 5, 10, 0)  # Sunday
    ...
    def test_public_holiday_surcharge(self):
        dt = datetime(2024, 5, 6, 10, 0)  # Weekday
    ...
    def test_short_trip_off_peak_free(self):
        dt = datetime(2024, 5, 6, 10, 0)  # Weekday, off-peak
        fare = bus_ticket_price(age=25, ride_datetime=dt, ride_duration=3, is_public_holiday=False)
        self.assertEqual(fare, 0.0)
